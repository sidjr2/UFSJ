...
public class Professor {
  ...
  public Professor(int id, int matricula, String nomeProfessor, String titularizacao,  String periododeEntrada, String email, String telefone, String endereco, String datadeNascimento){
    this.Id = id;
